		...
		<form action="" method="post" enctype="multipart/form-data">
				<div class="mfi-user-edit">
					...
					<div class="user_reg-from">
						<?php 
							if(isset($_SESSION['admin_update_user']) && !empty($_SESSION['admin_update_user'])){
								echo $_SESSION['admin_update_user'];
							} 
							$_SESSION['admin_update_user'] = '';
						 ?>
						<div class="registartion-form">
							...
							<div class="frm-row">
								<div class="frm-col">
									<button type="submit" class="edit-info-user" name="admin_user_update_info">Update</button>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="mfi-forms active" data-content="mfp">
						<div class="market-finance">
							...
							// $plugin_url = plugins_url();
								//echo $plugin_url.'/User-Investor/includes/mfp-update/mfi_infra_edit.php';
							//echo $plugin_url;
							 ?>
							
							<div class="mfp-right-form">
									<div class="form-sec active" data-tab-id="infra">
										<?php include(get_home_path().'wp-content/plugins/User-Investor/includes/mfp-update/mfi_infra_edit.php'); ?>
									</div>
									<div class="form-sec" data-tab-id="clients">
										<?php require(get_home_path().'wp-content/plugins/User-Investor/includes/mfp-update/mfi_clients_edit.php'); ?>
									</div>						
									<div class="form-sec" data-tab-id="products">
										<?php include(get_home_path().'wp-content/plugins/User-Investor/includes/mfp-update/mfi_products_edit.php'); ?>
									</div>
									<div class="form-sec" data-tab-id="cre-products">
										<?php include(get_home_path().'wp-content/plugins/User-Investor/includes/mfp-update/mfi_credit_products_edit.php'); ?>
									</div>
									<div class="form-sec" data-tab-id="dep-products">
										<?php include(get_home_path().'wp-content/plugins/User-Investor/includes/mfp-update/mfi_deposit_products_edit.php'); ?>
									</div>
									<div class="form-sec" data-tab-id="delinquency">
										<?php include(get_home_path().'wp-content/plugins/User-Investor/includes/mfp-update/mfi_delinquency_edit.php'); ?>
									</div>
									<div class="form-sec" data-tab-id="non-finance">
										<?php include(get_home_path().'wp-content/plugins/User-Investor/includes/mfp-update/mfi_non_financial_edit.php'); ?>
									</div>
									<div class="form-sec" data-tab-id="enter-financed">
										<?php include(get_home_path().'wp-content/plugins/User-Investor/includes/mfp-update/mfi_ent_financial_edit.php'); ?>
									</div>
									<div class="form-sec" data-tab-id="job-creation">
										<?php include(get_home_path().'wp-content/plugins/User-Investor/includes/mfp-update/mfi_job_creation_edit.php'); ?>
									</div>
									<div class="form-sec" data-tab-id="poverty-outreach">
										<?php include(get_home_path().'wp-content/plugins/User-Investor/includes/mfp-update/mfi_poverty_outreach_edit.php'); ?>
									</div>
									<div class="form-sec" data-tab-id="balance-sheet">
										<?php include(get_home_path().'wp-content/plugins/User-Investor/includes/mfp-update/mfi_balance_sheet_edit.php'); ?>
									</div>
									<div class="form-sec" data-tab-id="income-statement">
										<?php include(get_home_path().'wp-content/plugins/User-Investor/includes/mfp-update/mfi_income_statement_edit.php'); ?>
									</div>
									<div class="form-sec" data-tab-id="portfolio_summary">
										<?php include(get_home_path().'wp-content/plugins/User-Investor/includes/mfp-update/mfi_portfolio_summary_edit.php'); ?>
									</div>
									...
									<div class="form-sec" data-tab-id="detail_files">
										...
										?>
										<?php include(get_home_path().'wp-content/plugins/User-Investor/includes/mfp-update/mfi_detail_files_upload.php'); ?>
									</div>
									<div class="form-sec" data-tab-id="glossary">
										<?php include(get_home_path().'wp-content/plugins/User-Investor/includes/mfp-update/mfi_glossary_edit.php'); ?>
									</div>
						...
						<div class="market-finance">
							...
							<div class="mfp-right-form">
									<div class="form-sec active" data-tab-id="social-goals">
										<?php include(get_home_path().'wp-content/plugins/User-Investor/includes/msp-update/msp_social_goals_edit.php'); ?>
									</div>
									<div class="form-sec" data-tab-id="governance-hr">
										<?php include(get_home_path().'wp-content/plugins/User-Investor/includes/msp-update/msp_governance_hr_edit.php'); ?>
									</div>
									<div class="form-sec" data-tab-id="products-services">
										<?php include(get_home_path().'wp-content/plugins/User-Investor/includes/msp-update/msp_product_services_edit.php'); ?>
									</div>
									<div class="form-sec" data-tab-id="client-protection">
										<?php include(get_home_path().'wp-content/plugins/User-Investor/includes/msp-update/msp_client_protection_edit.php'); ?>
									</div>
									<div class="form-sec" data-tab-id="environment">
										<?php include(get_home_path().'wp-content/plugins/User-Investor/includes/msp-update/msp_environment_edit.php'); ?>
									</div>
